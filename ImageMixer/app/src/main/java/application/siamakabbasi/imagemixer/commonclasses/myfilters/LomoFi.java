package application.siamakabbasi.imagemixer.commonclasses.myfilters;
...
public class LomoFi extends Filter{
    ...
    private Bitmap changeCurves(Bitmap image) {
       ...
       curvesFilter.filter(mColors, width, height);
    ...
    private Bitmap desaturateImage(Bitmap image) {
        ...
        grayscaleFilter.filter(mColors,width, height);
